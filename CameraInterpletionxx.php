    ...
    if (!is_null($handler)) {
        ...
        foreach ($customers as $key => $customer) {
            ...
            if (!isTableInBase($contextDinamicoDoBancoSelecionado,TABLE_CAMERAS_MOVIMENTOS)) {
                ...
                $movimentosPreProcessados = recuperarMovimentoNaoProcessados($contextDinamicoDoBancoSelecionado);
...
//                dd([$movimento,$repeticao,$entradas,$saidas]);
        ...
        printIf($echos, "------'REPETICAO ".$repeticao);
